...
public class GridItemDecorationUtil extends RecyclerView.ItemDecoration {
        ...
        private GridItemDecorationUtil(int horizonSpan,int verticalSpan,int color,boolean showLastLine) {
...
//            //满足条件( 最后一行 && 不绘制 ) 将vertical多出的一部分去掉;
        ...
        public static class Builder {
            ...
            public GridItemDecorationUtil build() {
                return new GridItemDecorationUtil(mHorizonSpan, mVerticalSpan, mColor,mShowLastLine);
            }
        }
}
