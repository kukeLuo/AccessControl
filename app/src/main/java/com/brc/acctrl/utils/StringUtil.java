...
public class StringUtil {
    public static String CpStrPara(int strID) {
        return MainApplication.getAPPInstance().getString(strID);
    }

    public static String CpStrStrPara(int strID, String param) {
        String mStrStr = MainApplication.getAPPInstance().getString(strID);
        return String.format(mStrStr, param);
    }

    public static String CpStrIntPara(int strID, int intParam) {
        String mIntStr = MainApplication.getAPPInstance().getString(strID);
    ...
    public static Spanned CpStrHtmlColor(int strId) {
        return Html.fromHtml(MainApplication.getAPPInstance().getResources().getString(strId));
    }
