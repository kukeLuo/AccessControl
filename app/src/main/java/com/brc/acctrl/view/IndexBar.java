...
public class IndexBar extends View {
    ...
    private void initSetting(Context context, AttributeSet attrs) {
        ...
        float textSize = typedArray.getDimension(R.styleable.IndexBar_letterSize, 24);
        int letterColor = typedArray.getColor(R.styleable.IndexBar_letterColor,
                ContextCompat.getColor(getContext(), android.R.color.white));
        mLetterSpacingExtra = typedArray.getFloat(R.styleable.IndexBar_letterSpacingExtra, 1.1f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mNavigators.size() > 0) {
            ...
            for (int i = 0; i < mNavigators.size(); i++) {
                ...
                if (i == mFocusIndex) {
                    canvas.drawText(mNavigators.get(i).toUpperCase(), xPos, yPos - mBaseLineHeight, mFocusPaint);
                } else {
                    canvas.drawText(mNavigators.get(i).toUpperCase(), xPos, yPos - mBaseLineHeight, mPaint);
                }
            }
        }
    }
