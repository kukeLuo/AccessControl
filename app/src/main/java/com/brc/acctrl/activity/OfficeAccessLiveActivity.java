...
public class OfficeAccessLiveActivity extends BaseLiveCameraActivity {
    @BindView(R.id.ir_preview_view)
    TexturePreviewView irPreviewView;
    @BindView(R.id.ir_texture_view)
    TextureView irTextureView;
    ...
    public int getLayoutId() {
        ...
        if (mode == SPUtil.ACCESS_TYPE_BOSS) {
            return R.layout.activity_office_live;
        } else {
            return R.layout.activity_office_live_door;
        }
    }
    ...
    public void initViews() {
        ...
        loadVideo(videoView);
        initCameraPreviewLayout(previewView, textureView, irPreviewView, irTextureView);
        initSDK();
    }
